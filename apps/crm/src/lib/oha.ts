...
/**
 * Look up a tenant's OHA monthly limit: the rate matching rank +
 * dependent_status whose effective window contains `atDate` (default today).
 * Display/compare only — never auto-deducted (§9.4).
 */
